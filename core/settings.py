...
CATALOG: dict[str, Setting] = dict(
    [
        ...
        _s("NOVA_SPEAKER_KEEP_AUDIO", "bool", "0", "Retain raw enrollment recordings after building a profile. OFF by default: Nova needs the derived embeddings, not the recordings, and a stored voice sample is among the most personal things she could hold."),
